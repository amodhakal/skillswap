    ...
    <div className="min-h-screen w-screen flex justify-center items-center">
      <div className="bg-white shadow rounded-xl flex flex-col p-8">
        <div className="flex flex-col items-center mb-2">
          <h1 className="text-3xl font-extrabold mb-0.5">Welcome back!</h1>
          <p className="">Continue mastering that skill you always wanted.</p>
        </div>
        ...
        <div className="mt-2">
          <p className="flex justify-end">
            No account,
            <Link to="/auth/signup" className="ml-1 text-blue-600">
              sign in!
            </Link>
          </p>
        </div>
